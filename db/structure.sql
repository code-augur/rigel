...
--
-- Name: card_data_id_index; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX card_data_id_index ON cards USING btree (((data ->> 'id'::text)));


--
-- Name: index_cards_on_data; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
